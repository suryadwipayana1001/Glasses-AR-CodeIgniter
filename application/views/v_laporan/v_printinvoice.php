  ...
  <div class="row">
    <div class="col-12">
      <div class="card">
        <div class="card-body p-0">
          <div class="row p-4">
            <div class="col-md-6">
              <a href=""><img src="<?=base_url()?>assets/img/core-img/logo.jpeg" width="120" alt=""></a>

            </div>

            <div class="col-md-6 text-right">
             JK STORE BALI
             <h6>JL Dewata no 9 Sidakarya Denpasar</h6>
             <h6>Telp.+62146588229</h6>
           </div>
         </div>
            ...
            <tbody>
             ...
             foreach ($data1->result_array()as $i):
              ...
              <tr>
                ...
                <td><?php echo 'Rp.'.number_format($i['jumlah_dipesan'])?></td>
    ...
    <div class="d-flex flex-row-reverse bg- text-black p-1">
      ...
      <div class="py-2 px-5 text-right">
        ...
        <div class="h5 font-weight-light"><?php echo 'Rp.'.number_format($i['total_pemesanan'])?></div>
      </div>
      <div class="py-2 px-5 text-right">
        <div class="mb-1">Ongkos Kirim</div>
        <div class="h5 font-weight-light"><?php echo 'Rp.'.number_format($i['ongkir_pemesanan']);?></div>
      </div>
      <div class="py-2 px-5 text-right">
      ...
      <div class="py-2 px-5 text-right">
        ...
        <div class="h5 font-weight-light"><?php echo 'Rp.'.number_format($i['subtotal_pemesanan']);?></div>
      </div>
    </div>
  </div>
</div>
