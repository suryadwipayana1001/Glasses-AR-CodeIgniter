...
<head>
    ...
    <!-- Favicon  -->
    <link  href="<?php echo base_url('assets/img/core-img/favicon.ico')?>" rel="icon" />
    ...
    <div class="main-content-wrapper d-flex clearfix">
        ...
        <header class="header-area clearfix">
            ...
            <div class="cart-fav-search mb-100">
                <a href="cart.html" class="cart-nav"><img src="<?=base_url()?>assets/img/core-img/cart.png" alt=""> Cart <span>(0)</span></a>
                ...
                <div class="col-12 col-lg-4">
                    <div class="single_widget_area">
                        ...
                        <div class="footer-logo mr-50">
                            <a href="index.html"><img src="<?=base_url()?>assets/img/core-img/logo2.png" alt=""></a>
                        </div>
                        <!-- Copywrite Text -->
