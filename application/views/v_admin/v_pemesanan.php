        ...
        <div class="row">
                            ...
                            <table class="table table-striped table-bordered table-hover" id="dataTables-example">
                                ...
                                <tbody>
                                    ...
                                    foreach ($data->result_array()as $i):
                                        ...
                                        <tr class="odd gradeX">
                                            <td><?php echo $no++?></td>
                                            <td><?php echo $harga_pemesanan=$i['harga_pemesanan'];?></td>
                                            <td><?php echo $jumlah_pemesanan=$i['jumlah_pemesanan'];?></td>
                                            <td><?php echo $tanggal_pemesanan=$i['tanggal_pemesanan'];?></td>
            ...
            foreach($data->result_array() as $i):
                $id_pemesanan=$i['id_pemesanan'];
                $harga_pemesanan=$i['harga_pemesanan'];
                ?>
                        ...
                        <div class="modal-content">
                            ...
                            <form class="form-horizontal" method="post" action="<?php echo base_url().'index.php/pemesanan/hapus_pemesanan'?>">
                                <div class="modal-body">
                                    <p>Anda yakin mau menghapus <b><?php echo $harga_pemesanan;?></b></p>
                                </div>
