...
class m_pemesanan extends CI_Model{
	...
	function simpan_pemesanan($id_pemesanan,$nama_pemesanan,$provinsi_pemesanan,$kabupaten_pemesanan,$kecamatan_pemesanan,$alamat_pemesanan,$kodepos_pemesanan,$nohp_pemesanan,$kurir_pemesanan,$status_pemesanan){
		$hasil=$this->db->query("INSERT INTO tb_pemesanan(id_pemesanan,nama_pemesanan,provinsi_pemesanan,kabupaten_pemesanan,kecamatan_pemesanan,alamat_pemesanan,kodepos_pemesanan,nohp_pemesanan,kurir_pemesanan,status_pemesanan) VALUES('$id_pemesanan','$nama_pemesanan','$provinsi_pemesanan','$kabupaten_pemesanan','$kecamatan_pemesanan','$alamat_pemesanan','$kodepos_pemesanan','$nohp_pemesanan','$kurir_pemesanan','$status_pemesanan')");	
		return $hasil;
	}
